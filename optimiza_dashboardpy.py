...
if st.session_state.get('datos_cargados', False):
    with st.expander("Datos para Análisis", expanded=True):
        st.write("Aquí iría TODO tu flujo original intacto (Datos del Cliente, Competidores, Mining, Avoids)...")  # Aquí va tu código original
    ...
    with st.expander("Tabla Maestra de Datos Compilados", expanded=True):
        ...
        numeric_cols = ['Search Volume', 'ASIN Click Share', 'Total Click Share', 'Sample Click Share', 'Niche Click Share',
