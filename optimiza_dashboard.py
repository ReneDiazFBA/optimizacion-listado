...
if st.session_state.get('datos_cargados', False):
    st.write("Aquí irían tus secciones de Datos del Cliente, Competidores, Mining, Avoids, etc... (ya existentes en tu código original).")
    with st.expander("Tabla Maestra de Datos Compilados", expanded=True):
        ...
        if not st.session_state.df_mining_kw.empty:
            ...
            df_mining = pd.DataFrame(columns=['Search Terms', 'Relevance', 'Search Volume', 'Niche Product Depth', 'Niche Click Share', 'Source'])
