...
if archivo:
    ...
    st.data_editor(tabla_cust, key="editor_cust", num_rows="dynamic", use_container_width=True)
    ...
    st.data_editor(tabla_comp, key="editor_comp", num_rows="dynamic", use_container_width=True)
